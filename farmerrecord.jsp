...
<header class="head text-center pb-5">
                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li><a class="dropdown-item" href="#">Farmer List</a></li>
     ...
     <section class="blog-sec-1">
        <div class="image">
            <h1 class="text-white">Farmer List</h1>
        </div>
        <section>
...
//Execute Query
	ResultSet rs=stat.executeQuery("select * from farmer_regi");
while(rs.next()){
...
<td><a  href="UpdatedFarmer.jsp?id=<%=rs.getString(1)%>">Edit</a></td>
<td><a  href="DeletedFarmer.jsp?id=<%=rs.getString(1)%>">Delete</a></td>
</tr>
<%
}
}
