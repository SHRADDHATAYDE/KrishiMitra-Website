...
//Execute Query
	ResultSet rs=stat.executeQuery("select * from customer_register");
while(rs.next()){
...
<td><a  href="UpdateCustomer.jsp?id=<%=rs.getString(1)%>">Edit</a></td>
<td><a  href="DeleteCustomer.jsp?id=<%=rs.getString(1)%>">Delete</a></td>
</tr>
<%
}
}
