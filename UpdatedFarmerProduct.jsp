...
//Execute Query
	ResultSet rs=stat.executeQuery("select * from farmer_sell where id='"+id+"'");
...
<h3 class="playfair-display ">Product Name</h3>
<hr>
<input type="text" value="<%=rs.getString(2)%>" name="input1">

<h3 class="playfair-display ">Address</h3>
<hr>
<input type="text" value="<%=rs.getString(3)%>" name="input2">
...
<hr>
<input type="text" value="<%=rs.getInt(5)%>" name="input4">

<h3 class="playfair-display ">Date Of Sell</h3>
<hr>
...
<h3 class="playfair-display ">Total</h3>
<hr>
<input type="text" value="<%=rs.getString(8)%>" name="input7">

<h3 class="playfair-display ">Product Name</h3>
<hr>
<input type="text" value="<%=rs.getString(9)%>" name="input8">
<br>
<br>
