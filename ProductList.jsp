                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li><a class="dropdown-item" href="farmerrecord.jsp">Farmer List</a></li>
                                <li><a class="dropdown-item" href="customerrecord.jsp">Customer List</a></li>
                         ...
                         <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li><a class="dropdown-item" href="product.jsp">Farmer List</a></li>
                                <li><a class="dropdown-item" href="ProductList.jsp">Customer List</a></li>
...
<td><a  href="UpdatedProduct.jsp?id=<%=rs.getString(1)%>">Edit</a></td>
<td><a  href="DeleteProduct.jsp?id=<%=rs.getString(1)%>">Delete</a></td>
</tr>
<%
}
}
