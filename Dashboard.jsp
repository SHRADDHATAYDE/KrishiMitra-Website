                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                ...
                                <li><a class="dropdown-item" href="ProductList.jsp">Products List</a></li>
                         ...
                         <li class="nav-item">
                            <a class="nav-link text-uppercase" href="farmerproduct.jsp">Farmer Products</a>
                        </li>
                        
                        <li class="nav-item">
                            <a class="nav-link text-uppercase" href="login.jsp">LogOut</a>
                        </li>
                    </ul>
